...
@section('content')
    <div class="container mt-4">
        <h1>Edit Data </h1>
        <form action="{{route('editlisa',['id'=>$data->id])}}" method="post" enctype="multipart/form-data" >
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="email" placeholder="Enter name" value="{{$data->email}}">
            </div>
            <div class="form-group">
